                ...
                {!! csrf_field() !!}
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" id="phone" name="phone" class="form-control"  required placeholder="e.g. 9843360552">
                        </div><!-- /.form-group -->
                    </div><!-- col-lg-6 -->
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="date_of_birth" class="form-control" date="true" required placeholder="e.g. 2051-01-05">
                        </div><!-- /.form-group -->
                    </div><!-- col-lg-6 -->
